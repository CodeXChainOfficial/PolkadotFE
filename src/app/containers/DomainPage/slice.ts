...
import { SubDomainsType } from "app/types"
import { DurationType, SerializeDomainType, SerializeTransferDomainType } from "utils/cryptoXconvertors"
...
const domainPageSlice = createSlice({
  ...
  reducers: {
    ...
    transferDomain(state, action: PayloadAction<SerializeTransferDomainType>) {},
...
export const { actions: DomainPageActions, reducer: DomainPageReducer, name: sliceKey } = domainPageSlice
