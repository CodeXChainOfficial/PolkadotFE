...
import { WalletQrCodeSubscriber, WalletRejectionSubscriber } from "services/message_service"

export const WalletQrCodeDataDistributor = () => {
  const dispatch = useDispatch()

  useEffect(() => {
    const walletRejectionSubscription = WalletRejectionSubscriber.subscribe((message) => {
