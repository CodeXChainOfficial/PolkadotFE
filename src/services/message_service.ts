import { QrCodeWalletConnectorDataType, TransferMessage, WalletInfoDataType } from "app/types"
...
const WalletQrCodeSubscriber: Subject<QrCodeWalletConnectorDataType> = new Subject()
